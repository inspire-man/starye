...
- [ ] 打开 `apps/movie-app/src/views/Search.vue`
- [ ] 引入自定义 Select 组件
- [ ] 替换排序选择器
- [ ] 调整样式适配
- [ ] 测试排序功能
...
- [ ] 打开 `apps/movie-app/src/views/Actors.vue`
- [ ] 引入自定义 Select 组件
- [ ] 替换排序选择器（line 74-84）
- [ ] 替换状态选择器（line 99-109）
- [ ] 替换详情选择器（line 114-124）
- [ ] 调整样式适配
- [ ] 测试所有筛选功能

### 3.4 替换 Publishers.vue 下拉组件

- [ ] 打开 `apps/movie-app/src/views/Publishers.vue`
- [ ] 引入自定义 Select 组件
- [ ] 替换排序选择器
- [ ] 替换详情选择器
- [ ] 调整样式适配
...
- [ ] 打开 `apps/movie-app/src/views/Profile.vue`
- [x] 引入自定义 Select 组件
- [x] 实现 Tab 下拉选择器（移动端）
- [x] 保留桌面端 Tab 栏
