...
- [x] 3.3 Verify full-success, partial-success and empty-result states through `http://localhost:8080/quant/`; completion: visible outcomes have no console errors.
