...
- [x] 3.3 Verify the report-present, one-run empty, success, failure/retry and citation navigation states through `http://localhost:8080/quant/` without console errors or deterministic-data mutation.
