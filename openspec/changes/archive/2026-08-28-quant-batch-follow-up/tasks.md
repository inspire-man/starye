...
- [x] 3.3 Verify the flow through `http://localhost:8080/quant/` at desktop and narrow viewport; completion: successful navigation and failed-item retry states are observable without console errors.
