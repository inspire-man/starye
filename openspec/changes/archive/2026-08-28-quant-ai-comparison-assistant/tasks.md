...
- [x] 3.3 通过 `http://localhost:8080/quant/` 验证未点击无请求、成功/失败/重试/引用导航和 390px 布局；完成标准：无 console error/warn，AI 不改变确定性数据。（当前真实用户数据仅有 1 份可用研究运行，成功/失败/重试和引用跳转仍需在具备 2-3 份运行后复核。）
