...
- [x] 3.3 Verify through `http://localhost:8080/quant/` with report-present, report-absent, success, failure/retry and citation navigation states; completion: no console error/warn and deterministic report data remains unchanged.
