...
- [x] 4.3 Verify through Gateway and D1 readback, then commit, push, review PR Actions and merge; complete when bridge unavailable and AI unavailable are visibly honest states.
