...
- [x] 3.3 Show latest watchlist price/change and data freshness.
- [x] 3.4 Remove operations-only capability, points, provider, administrator-session, and Gateway-session presentation from the selection workbench.
- [x] 3.5 Add a first-viewport focus ranking, data-based risk notes, novice-readable signal labels, and data coverage/freshness metrics.
