...
- [x] 3.3 Verify Gateway route and download-ready report states through `http://localhost:8080/quant/`; completion: report-present and report-absent behavior is observable without console errors.
