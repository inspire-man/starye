...
- [x] 3.3 Verify full-success, partial-success, empty and clipboard-failure states through `http://localhost:8080/quant/`; completion: visible outcomes have no console errors.
