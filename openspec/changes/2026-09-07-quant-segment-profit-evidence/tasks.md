...
- [ ] 3.2 Run type-check/build/lint/OpenSpec strict/GitNexus detection, Gateway/UI verification, commit and merge the PR, then verify Actions on the merge commit.
