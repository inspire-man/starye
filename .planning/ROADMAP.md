...
- [ ] 16-01-PLAN.md — 固化任务/attempt/lease/log 的 D1 模型、状态机与保留契约。

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 16-02-PLAN.md — 提供受会话与资源权限保护的固定模板任务命令、查询、取消与重试 API。
- [ ] 16-03-PLAN.md — 提供独立 HMAC runner-event 回调、日志脱敏与 90 天明细日志清理。
