...
- [x] 26-01-PLAN.md — 四层视频事实、probe policy 与 reason-specific action contract

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 26-02-PLAN.md — operation registry 与 signed runner transport

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 26-03-PLAN.md — magnet provider probe、adapter 与 selection-only registry contract
- [ ] 26-04-PLAN.md — direct source transport 与 bounded browser evidence
...
- [ ] 26-07-PLAN.md — Player same-revision consumption evidence
- [ ] 26-10-PLAN.md — public GET /api/public/movies/:code authoritative current/history readback
...
| 26. Video Source And Magnet Availability | v1.5 | 3/10 | In Progress | - |
