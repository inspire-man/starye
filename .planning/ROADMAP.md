...
- [x] 21-01-PLAN.md — source health、repair operation contracts 与 Drizzle schema
...
- [x] 21-03-PLAN.md — operation registry、repair receipt 与 task lifecycle/CAS/retry

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 21-04-PLAN.md — admin repair command 与 signed runner callback routes
...
- [x] 23-01-PLAN.md — Provider contract、GitHub Actions client 与 coverage audit
- [x] 23-02-PLAN.md — 复用 movie workflow 并接入 claim-time repair adapter
- [x] 23-03-PLAN.md — D1 bounded retry、reconciliation、receipt 与 source CAS
- [x] 23-04-PLAN.md — Signed callback、duplicate/stale/conflict 与 receipt boundary
- [x] 23-05-PLAN.md — Admin DTO、current-attempt Dashboard、history 与 duplicate lock
...
**Plans**: 5 plans
Plans:
- [ ] 24-01-PLAN.md — 定义 playback evidence 契约、脱敏边界与 playback_verified projection
- [ ] 24-02-PLAN.md — 建立 D1/CAS persistence、authenticated evidence endpoint 与 task detail projection
