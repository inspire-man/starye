...
- ✅ **v1.1 存储成本控制与代码/文件整理** - Phases 6-10 shipped 2026-07-13. Archived at milestone closeout.

## Current Status

v1.1 shipped with a read-only R2 audit boundary, external comic chapter images, upload/crawler cost guardrails, tightened doc ownership, and shared storage semantics cleanup across API/crawler/admin/scripts.
...
| 9 | Documentation Restructure | Complete 2026-07-13. Root entry docs, archive boundaries, and RUNBOOK ownership were tightened. | DOC-01, DOC-02, DOC-03, DOC-04 |
| 10 | Storage Code Cleanup | Complete 2026-07-13. Shared storage helpers, policy-aware pending heuristics, legacy script cleanup, and protected regressions all passed. | CODE-01, CODE-02, CODE-03, CODE-04 |
...
- [x] 10-01-PLAN.md — 扩 `@starye/api-types` shared storage helper，并让 upload route 接上 canonical key/url contract。

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 10-02-PLAN.md — 让 `ImageProcessor` 与 admin actor/publisher pending heuristics 改用 shared storage semantics。
- [x] 10-03-PLAN.md — 收口 legacy cover scripts 的 R2-first 叙事，并复跑 protected external-image regressions。
...
Milestone closeout completed on 2026-07-13 via:
...
---
*Last updated: 2026-07-13 after Phase 10 closeout*
