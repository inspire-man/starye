# Roadmap Archive: Starye — 个人内容中台 v1.5
...
- ✅ **v1.5 爬虫运管与内容可用性闭环** — Phases 25-28 shipped 2026-08-22
...
- [x] **Phase 27: Comic Chapter Completeness** - 完成漫画 source snapshot、缺章/重复/顺序诊断和定向重抓。
- [x] **Phase 28: Chapter Image Availability And Gateway Acceptance** - 完成章节图片探测、定向修复和全链路 Gateway 证据验收。
