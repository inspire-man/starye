...
DROP INDEX IF EXISTS `idx_actor_source_id`;--> statement-breakpoint
DROP INDEX IF EXISTS `idx_movie_actor`;--> statement-breakpoint
DROP INDEX IF EXISTS `idx_movie_actor_actor_id`;--> statement-breakpoint
DROP INDEX IF EXISTS `idx_movie_pub`;--> statement-breakpoint
DROP INDEX IF EXISTS `idx_movie_pub_publisher_id`;--> statement-breakpoint
DROP INDEX IF EXISTS `idx_publisher_source_id`;--> statement-breakpoint
DROP INDEX IF EXISTS `idx_reading_progress_user_chapter`;--> statement-breakpoint
