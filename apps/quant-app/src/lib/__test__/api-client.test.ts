          ...
          cashflow_evidence: {
            ...
            history: [
              ...
              },
              {
                ...
                free_cashflow: 150,
                free_cashflow_coverage: 3,
                interest_expense: 10,
                interest_bearing_debt: 180,
                free_cashflow_after_interest: 140,
                payout_ratio: 25,
                missing_fields: [],
              },
            ],
            history_summary: {
              formula_version: 'shareholder-cashflow-history-v1',
              status: 'ready',
              period_count: 2,
              core_ready_period_count: 2,
              positive_free_cashflow_periods: 2,
              positive_free_cashflow_after_interest_periods: 2,
              covered_dividend_periods: 2,
              payout_ratio_period_count: 1,
      ...
      items: [{
        ...
        cashflowEvidence: expect.objectContaining({
          ...
          history: expect.arrayContaining([
            expect.objectContaining({ reportDate: '2026-06-30', freeCashflow: 70, freeCashflowAfterInterest: 60 }),
            expect.objectContaining({ reportDate: '2025-12-31', freeCashflow: 150, payoutRatio: 25 }),
          ]),
          historySummary: expect.objectContaining({ status: 'ready', periodCount: 2, coveredDividendPeriods: 2 }),
        }),
    ...
    await expect(quantApi.getShareholderReturns()).resolves.toMatchObject({
      items: [{
        ...
        cashflowEvidence: {
          ...
          history: [],
          historySummary: expect.objectContaining({ status: 'insufficient_data', periodCount: 0 }),
        },
      }],
    })
  })
