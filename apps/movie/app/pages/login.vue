...
<template>
  <div class="flex items-center justify-center min-h-[calc(100vh-200px)] px-4">
    <div class="w-full max-w-sm p-10 space-y-8 bg-card rounded-3xl border border-border/40 shadow-xl text-center">
      ...
      <button
        :disabled="loading"
        class="w-full flex items-center justify-center gap-3 px-6 py-3 bg-neutral-900 text-white hover:bg-neutral-800 rounded-xl font-bold transition-all disabled:opacity-50"
