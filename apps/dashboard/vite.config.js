...
import { buildVitePublicRuntimeEnv, parsePagesBuildEnvText, parseVitePublicRuntimeEnv } from '@starye/config/deployment-target'
...
const publicRuntimeEnv = buildVitePublicRuntimeEnv(parseVitePublicRuntimeEnv(parsePagesBuildEnvText(readFileSync(pagesBuildEnvPath, 'utf8'), 'dashboard'), 'dashboard'), 'dashboard')
