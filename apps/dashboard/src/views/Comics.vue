...
async function deleteChapter(id: string) {
  if (!confirm(t('dashboard.confirm_delete') || 'Are you sure you want to delete this chapter?'))
    return
...
<template>
  <div class="space-y-6 relative">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
      ...
      >
        ...
        <div class="w-28 shrink-0 bg-neutral-100 dark:bg-neutral-800 relative">
          ...
          <div v-if="comic.metadataLocked" class="absolute top-1 right-1 bg-amber-500 text-[8px] text-white font-black px-1 rounded uppercase">
            LOCKED
          </div>
        </div>
    ...
    <div v-if="isEditModalOpen && editingComic" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div class="w-full max-w-2xl bg-white dark:bg-neutral-900 rounded-3xl shadow-2xl overflow-hidden border border-neutral-200 dark:border-neutral-800 animate-in fade-in zoom-in duration-200 flex flex-col max-h-[90vh]">
        <!-- Header -->
        ...
        <div class="p-8 overflow-y-auto flex-1">
          ...
          <div v-if="activeTab === 'metadata'" class="space-y-5">
            ...
            <div class="flex items-center justify-between p-4 bg-amber-50 dark:bg-amber-900/20 rounded-2xl border border-amber-100 dark:border-amber-900/50">
              <div>
              ...
              <input v-model="editingComic.metadataLocked" type="checkbox" class="w-5 h-5 accent-amber-600 cursor-pointer">
            </div>
            ...
            <div v-else class="border border-neutral-200 dark:border-neutral-800 rounded-xl overflow-hidden">
              <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-neutral-100 dark:divide-neutral-800">
                  <tr v-for="chapter in chapters" :key="chapter.id" class="hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
                    ...
                    <td class="px-4 py-3 text-right">
                      <button class="text-red-600 hover:text-red-700 font-bold text-xs" @click="deleteChapter(chapter.id)">
                        Delete
                      </button>
                    </td>
                  </tr>
        ...
        <!-- Footer -->
        <div class="p-6 bg-neutral-50 dark:bg-neutral-800/50 border-t border-neutral-100 dark:border-neutral-800 flex gap-3 shrink-0">
