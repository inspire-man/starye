...
const responseSchemas: Record<string, Parameters<typeof resolver>[0]> = {
  ...
  QuantScheduledResearchHistoryResponseSchema: quantSchemas.QuantScheduledResearchHistoryResponseSchema,
  QuantScheduledResearchRunTriggerResponseSchema: quantSchemas.QuantScheduledResearchRunTriggerResponseSchema,
