...
export const QUANT_KNOWLEDGE_FACTORS: readonly QuantKnowledgeFactor[] = [
  ...
  },
  {
    ...
    availableFields: ['operatingCashflowToRevenue'],
  ...
  },
  {
    ...
    availableFields: [],
    missingFields: ['dividendYield', 'payoutRatio', 'freeCashflow', 'buybackAmount', 'sharesOutstandingChange'],
    status: 'planned',
    eligibleInValueQuality: false,
    currentDimension: null,
  ...
  },
  {
    ...
    availableFields: ['debtAssetRatio', 'operatingCashflowToRevenue'],
